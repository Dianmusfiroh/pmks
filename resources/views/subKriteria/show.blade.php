...
<form action="{{ route($modul.'.store')}}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input type="text" name="nama_sub" id="nama_sub" value="" class="form-control mt-2" placeholder="Masukan Sub Data Kriteria">
        </div>
    </div>
    <div class="form-group row">
        <div class="label col-md-3">Bobot </div>
        <div class="col-md-9">
            <input type="text" name="nilai" id="nilai" value="" class="form-control mt-2" placeholder="Masukan Bobot Sub Data Kriteria">
        </div>
    </div>
