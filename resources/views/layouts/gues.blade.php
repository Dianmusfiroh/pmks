<head>
  ...
  <div class="header__logo"><img class="header__img" src="https://image.ibb.co/kcVou6/path3000.png"> <h1 class="header__title">PMKS<span class="header__light"></span></h1></div>
    ...
    <div class="header__menu">
      <nav id="navbar" class="header__nav collapse">
        <ul class="header__elenco">
          ...
          <li class="header__el"><a href="#" class="header__link">Statistik</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 col-xs-6">
         <img class="footer__img" src="https://image.ibb.co/kcVou6/path3000.png"> <h1 class="footer__title">PMKS<span class="footer__light"></span></h1></div>
