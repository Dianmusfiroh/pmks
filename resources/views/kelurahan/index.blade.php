...
<h1>{{ Str::title(Str::replaceArray('-',[' '],'Data Kelurahan' ?? '')) }}</h1>
@stop

@section('card-header-extra')
<div class="float-right">
    <a href="{{ route($modul.'.create') }}" id="btnDetail"  data-toggle="modal" data-target=".bd-example-modal-lg" class="btn btn-primary btn-sm"><i class="fas fa-fw fa-plus"></i>
        Tambah Data</a>
</div> 
...
<table class="table table-bordered table-striped table-sm text-center" id="myTable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route($modul.'.edit', $item->id) }}" title="{{ $item->nama }}"  id="btnEdit" class="btn btn-sm btn-success"><i class="material-icons md-edit"></i> Edit</a>
