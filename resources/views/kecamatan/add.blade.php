...
<form action="{{ route($modul.'.store')}}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input type="text" name="nama_camat" id="nama_camat" class="form-control mt-2" placeholder="Masukan Nama Lengkap">
        </div>
    </div>
    <div class="form-group row">
        <div class="label col-md-3">NIP</div>
        <div class="col-md-9">
            <input type="number" name="nip" id="nip" class="form-control mt-2" placeholder="Masukan Nomor Hp">
        </div>
    </div>
